...
if __name__ == "__main__":
    ...
    with open(r"E:\Quant\SignalEva\src\cons\etfSignalEva.json5", "r", encoding="utf-8") as f:
        sigCfg = json5.load(f)
    signalList = session.run("""
    exec factor from loadTable("dfs://daySignalEtf", "info");
    """)
    session.run("""
    etfList = loadText("E:/Quant/Basic/etf.csv")["symbol"]
    """)
